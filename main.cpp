...
// void send_arp_packet(handle_, eth_dmac, eth_smac, arp_smac, arp_sip, arp_tmac, arp_tip){
...
// void arp_request_to_sender(handle_, eth_dmac, eth_smac, arp_smac, arp_sip, arp_tmac, arp_tip){
//     send_arp_packet(handle_, eth_dmac, eth_smac, arp_smac, arp_sip, arp_tmac, arp_tip);
// }

// void get_sender_mac_address(handle_){
//     while (true) {
...
// void arp_reply_attack(handle_,handle_, eth_dmac, eth_smac, arp_smac, arp_sip, arp_tmac, arp_tip){
//     send_arp_packet(handle_, eth_dmac, eth_smac, arp_smac, arp_sip, arp_tmac, arp_tip);
// }
...
//     thread receive_arp_reply_thread(get_sender_mac_address);
//     thread send_arp_request_thread(arp_request_to_sender);

//     receive_arp_reply_thread.join();
//     send_arp_request_thread.join();

//     while(true){
//     arp_reply_attack(handle);
//     }
